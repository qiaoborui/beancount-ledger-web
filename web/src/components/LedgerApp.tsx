...
export function LedgerApp({ page: pageProp }: { page?: LedgerPage }) {
  ...
  return (
    ...
    >
      ...
      {page === "home" && <HomePage summary={summary} chart={chart} privacySettings={privacySettings} sensitiveUnlocked={unlocked} creditCards={creditCards} expenseAnalytics={incomeStatement?.expenseAnalytics ?? []} budgetRows={budgetRows} accountStatuses={accountStatuses} incomeStatement={incomeStatement} onPrivacyChange={updatePrivacySetting} onSelectCategory={openCategoryTransactions} />}
