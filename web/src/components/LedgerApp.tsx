...
export function LedgerApp({ page: pageProp }: { page?: LedgerPage }) {
  ...
  const { accountLabelMap, expenseAccounts, incomeAccounts, paymentAccounts, visibleBalances, netWorthChart } = useLedgerDerivedData({ summary, accounts, balances, accountBalances, netWorthRows, page, valuationCurrency });
