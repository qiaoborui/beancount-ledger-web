...
export function LedgerAgentWorkspace({
  ...
  if (presentation === "page") return <section className="ledger-agent-page fixed inset-0 z-40 flex min-h-0 min-w-0 max-w-full overflow-hidden bg-paper md:static md:z-auto md:h-dvh" aria-label="账本 Agent 工作区">
