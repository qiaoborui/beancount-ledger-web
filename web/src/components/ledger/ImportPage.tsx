  ...
  return (
    <div className="mx-auto min-w-0 max-w-[1220px] space-y-5 overflow-hidden">
      ...
      {preview ? (
        ...
        >
          <div className="-mx-4 -my-4 flex min-h-full min-w-0 flex-col bg-paper sm:-mx-5">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-3 px-3 py-3 sm:px-5 xl:min-h-0">
              {commitResult?.ok ? (
