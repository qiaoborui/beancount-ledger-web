...
export function CreditCardPanel({ cards, statuses, visibleAccountMap = {}, visible, onToggleAccount }: { cards: CreditCardAnalytics[]; statuses: AccountStatus[]; visibleAccountMap?: Record<string, boolean>; visible: boolean; onToggleAccount?: (account: string) => void }) {
