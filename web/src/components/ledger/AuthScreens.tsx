...
export function SensitiveUnlockPanel({ title = "资产信息已隐藏", description = "净资产和账户余额需要确认是你本人后查看。普通记账、流水和损益分析可以直接使用。", message, onUnlock }: { title?: string; description?: string; message?: string; onUnlock: () => void }) {
