...
export type InvestmentLiveQuote = { commodity: string; commodityName: string; amount: number; currency: string; source: string; status: "live" | "delayed" | "close" | "ledger" | "error"; symbol?: string; previousClose?: number; change?: number; changePercent?: number; marketValue?: number; marketValueCny?: number; updatedAt: string; error?: string };
