...
export type InvestmentSummary = { totalMarketValueCny: number; positions: InvestmentPosition[]; quotes: InvestmentQuote[]; updatedAt?: string };
...
export type DashboardFilterOption = { value: string; label: string; count: number };
...
export type LedgerPage = "home" | "dashboard" | "net-worth" | "investments" | "transactions" | "accounts" | "budgets" | "imports" | "reconcile" | "settings" | "income-statement";
export type LedgerNavHref = "/" | "/dashboard" | "/transactions" | "/accounts" | "/budgets" | "/imports" | "/net-worth" | "/investments" | "/income-statement" | "/reconcile" | "/settings";
