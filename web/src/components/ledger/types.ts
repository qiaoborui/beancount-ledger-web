...
export type InvestmentPosition = { account: string; accountLabel: string; commodity: string; commodityName: string; quantity: number; latestPrice?: CommodityPrice; averageCost?: number; costValue?: number; costCurrency?: string; marketValue?: number; marketCurrency?: string; marketValueCny?: number };
...
export type InvestmentSummary = { totalMarketValueCny: number; holdings?: InvestmentHolding[]; positions: InvestmentPosition[]; quotes: InvestmentQuote[]; updatedAt?: string };
