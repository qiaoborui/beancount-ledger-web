...
export type InvestmentHolding = { commodity: string; commodityName: string; latestPrice?: CommodityPrice; priceHistory: CommodityPrice[]; totalQuantity: number; totalMarketValue?: number; marketCurrency?: string; totalMarketValueCny?: number; accountCount: number; positions: InvestmentPosition[] };
