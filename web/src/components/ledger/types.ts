...
export type InvestmentPosition = { account: string; accountLabel: string; commodity: string; commodityName: string; quantity: number; latestPrice?: CommodityPrice; marketValue?: number; marketCurrency?: string; marketValueCny?: number };
...
export type InvestmentHolding = { commodity: string; commodityName: string; latestPrice?: CommodityPrice; priceHistory?: CommodityPrice[] | null; totalQuantity: number; totalMarketValue?: number; marketCurrency?: string; totalMarketValueCny?: number; accountCount: number; positions?: InvestmentPosition[] | null };
