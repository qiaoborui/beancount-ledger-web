...
export type InvestmentPosition = { account: string; accountLabel: string; commodity: string; commodityName: string; quantity: number; latestPrice?: CommodityPrice; averageCost?: number; costValue?: number; costCurrency?: string; marketValue?: number; marketCurrency?: string; marketValueCny?: number; lots?: InvestmentLot[] | null };
...
export type InvestmentHolding = { commodity: string; commodityName: string; latestPrice?: CommodityPrice; priceHistory?: CommodityPrice[] | null; totalQuantity: number; averageCost?: number; totalCostValue?: number; costCurrency?: string; totalMarketValue?: number; marketCurrency?: string; totalMarketValueCny?: number; accountCount: number; positions?: InvestmentPosition[] | null; lots?: InvestmentLot[] | null };
