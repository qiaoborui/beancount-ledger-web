...
func TestRegisteredAPIRoutesHaveIntegrationCoverage(t *testing.T) {
	...
	covered := map[string]bool{
		...
		"POST /api/setup/test":                   true,
		"POST /api/setup/install":                true,
		"GET /api/indexer/config":                true,
		"GET /api/runtime-config":                true,
		"PUT /api/runtime-config":                true,
		"POST /api/auth/login":                   true,
		"POST /api/auth/lock":                    true,
		"POST /api/auth/logout":                  true,
		"GET /api/auth/me":                       true,
		"GET /api/onboarding":                    true,
		"POST /api/onboarding/agent":             true,
		...
		"DELETE /api/passkey/credentials/:id":    true,
		...
		"GET /api/ledger/home-report":            true,
		...
		"GET /api/ledger/bql-history":            true,
		"POST /api/ledger/bql-history":           true,
		"POST /api/ledger/bql-history/:id/title": true,
		"PATCH /api/ledger/bql-history/:id":      true,
		"DELETE /api/ledger/bql-history/:id":     true,
		...
		"POST /api/ai/agent/approval":            true,
...
func TestAPIRouteSmokeCoverage(t *testing.T) {
	...
	for _, route := range []struct {
		...
		{http.MethodGet, "/api/ledger/bql-history", ""},
