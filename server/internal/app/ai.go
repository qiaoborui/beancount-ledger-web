...
- create: 创建账户，字段 kind,date,account,alias,currency,group。currency 必须是账本 commodities 中已定义的 token，例如 CNY/HKD/USD/GBP/EUR；group 可用 cash/wealth/credit/receivable/expense/income/equity/other。
