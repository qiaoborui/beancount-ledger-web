...
func TestGomobileSurface(t *testing.T) {
	...
	methods := map[string]bool{"PriceLookup": true, "ValueLegacyCents": true, "Build": true, "Open": true, "Accounts": true, "AccountBalances": true, "AccountSummary": true, "AccountActivity": true, "Transactions": true, "Detail": true, "DetailRecords": true, "Cancel": true, "Lock": true, "Unlock": true, "Close": true}
